...
! output file.
  ...
  subroutine outfile_initialize(elem, hybrid, infile, outfile, interpdata, infilename )
    ...
    if (hybrid%par%masterproc) print *,'registering output variables -- if you get a seg fault,&
	 try increasing the number of processors used to help memory management'
